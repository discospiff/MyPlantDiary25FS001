...
namespace PlantPlacesSpecimen
{
    ...
    public partial class Specimen
    {
        public static List<Specimen> FromJson(string json) => JsonConvert.DeserializeObject<List<Specimen>>(json, PlantPlacesSpecimen.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this List<Specimen> self) => JsonConvert.SerializeObject(self, PlantPlacesSpecimen.Converter.Settings);
    }
